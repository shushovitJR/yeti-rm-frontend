...
const AddRepairForm = ({ isOpen, onClose, onAdd }) => {
  ...
  return (
    <>
      {/* overlay: use explicit rgba and zIndex to ensure semi-transparent backdrop */}
      <div
        className="fixed inset-0 bg-black bg-opacity-50 z-40"
        onClick={onClose}
        style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', zIndex: 1000 }}
      />
      {/* panel/drawer: ensure it's above the overlay */}
      <div
